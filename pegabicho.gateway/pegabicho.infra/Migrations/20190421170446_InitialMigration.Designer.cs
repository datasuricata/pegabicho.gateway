...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("pegabicho.domain.Entities.Core.Ticket.Ticket", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("pegabicho.domain.Entities.Core.Pets.Pet", b =>
                {
                    b.HasOne("pegabicho.domain.Entities.Core.Users.User")
                        .WithMany("Pets")
            ...
            modelBuilder.Entity("pegabicho.domain.Entities.Core.Pets.Race", b =>
                {
                    b.HasOne("pegabicho.domain.Entities.Core.Pets.Pet", "Pet")
                        .WithOne("Race")
                        .HasForeignKey("pegabicho.domain.Entities.Core.Pets.Race", "PetId");
                });

            modelBuilder.Entity("pegabicho.domain.Entities.Core.Surveys.ImageSurvey", b =>
                {
                    b.HasOne("pegabicho.domain.Entities.Core.Surveys.Survey")
                        .WithMany("Images")
            ...
            modelBuilder.Entity("pegabicho.domain.Entities.Core.Ticket.Ticket", b =>
                {
                    ...
                    b.HasOne("pegabicho.domain.Entities.Core.Users.User", "Racer")
                        .WithMany()
